...
def discover_streams(client):
    ...
    for s in STREAMS.values():
        ...
        streams.append({'stream': s.name, "key_properties": s.key_properties, "replication_key": s.replication_key,
                        "replication_method": s.replication_method, 'tap_stream_id': s.name, 'schema': schema,
